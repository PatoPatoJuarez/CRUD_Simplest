...
router.post('/juicio/:juicioId', async (req, res) => {
  try {
...
router.get('/juicio/:juicioId', async (req, res) => {
  try {
    const ID_Juicio = parseInt(req.params.juicioId);
    const ID_Abogado = req.user.id;
...
router.get('/:id/juicio/:juicioId', async (req, res) => {
  try {
...
router.put('/:id/juicio/:juicioId', async (req, res) => {
  try {
    const ID_Historial = parseInt(req.params.id);
    const ID_Juicio = parseInt(req.params.juicioId);
    const ID_Abogado = req.user.id;
...
router.delete('/:id/juicio/:juicioId', async (req, res) => {
  try {
    const ID_Historial = parseInt(req.params.id);
    const ID_Juicio = parseInt(req.params.juicioId);
    const ID_Abogado = req.user.id;
